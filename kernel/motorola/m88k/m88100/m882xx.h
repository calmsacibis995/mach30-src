 ...
 * HISTORY
 * $Log:	m882xx.h,v $
 * Revision 2.7  93/03/09  18:01:58  danner
 ...
 * 	[93/02/11            jfriedl]
 * 
 * Revision 2.6  93/02/01  09:46:13  danner
 * 	Added () to NBPG define.
 * 	[93/01/28            jfriedl]
 * 
 * Revision 2.5  93/01/26  18:01:01  danner
 * 	Added cmmu.c prototypes, fixed includes.
 * 	[93/01/22            jfriedl]
 * 
 * Revision 2.4  93/01/14  17:53:20  danner
 * 	u_int --> unsigned
 * 	[92/12/02            jfriedl]
 * 
 * Revision 2.3  92/08/03  17:52:08  jfriedl
 * 	Add defines of INST_CMMU, DATA_CMMU for new pmap module. [danner]
 * 
 */


#ifndef	__MOTOROLA_M88K_M88100_M882XX_H__
#define	__MOTOROLA_M88K_M88100_M882XX_H__

#ifndef ASSEMBLER
# include <mach/m88k/vm_types.h> /* vm_offset_t */
# include <m88k/mmu.h>		 /* batc_template_t */
#endif
#include <machine/board.h>	/* MAX_CPUS */
...
/*
 * Prototypes and stuff from "motorola/m88k/m88100/cmmu.c".
 */
...
#define NBPW    4             /* bytes per word */
#define NBSG    (4*1024*1024) /* segment size */
#define NBPG    (4*1024)      /* bytes per mmu page */

#endif	/* __MOTOROLA_M88K_M88100_M882XX_H__ */
